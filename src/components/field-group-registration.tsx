...
type FieldGroupRegistrationProps = {
  ...
  showOrganizationChangeInfo?: boolean;
};
...
export const FieldGroupRegistration = withFieldGroup({
  ...
  render: function Render({
    ...
    emailSlot,
    domain = null,
    showOrganizationChangeInfo = false,
  }) {
    return (
      <FieldGroup>
        <group.AppField
                ...
                <field.FieldSelect
                  ...
                  description={
                    <>
                      ...
                      <HelpTicketLink />.{" "}
                      {showOrganizationChangeInfo && (
                        <>
                          Changing your institution to another institution in
                          the same country does not affect your current
                          allocations.
                        </>
                      )}
                    </>
